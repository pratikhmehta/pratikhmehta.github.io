        ...
        <Reveal className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {projects.map((project, index) => (
              <RevealItem
                key={index}
                className="rounded-xl overflow-hidden border border-slate-200 dark:border-ink-700 transition-shadow duration-300 hover:shadow-lg bg-white dark:bg-ink-900"
              >
                <div className="p-6">
