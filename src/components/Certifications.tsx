          ...
          <div className="grid md:grid-cols-2 gap-6">
            {certifications.map((cert) => (
              <RevealItem key={cert.name}>
                <MotionCard className="h-full p-6 rounded-xl border border-slate-200 dark:border-ink-700 hover:border-accent-500/40 dark:hover:border-accent-400/40 hover:shadow-xl hover:shadow-slate-900/5 dark:hover:shadow-black/20 transition-[border-color,box-shadow] duration-300 flex flex-col">
